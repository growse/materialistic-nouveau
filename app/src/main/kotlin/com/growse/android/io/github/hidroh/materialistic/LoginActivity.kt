...
class LoginActivity : AccountAuthenticatorActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginButton = findViewById<View>(R.id.login_button).apply{
            setOnClickListener(View.OnClickListener { _: View? ->
                if (!validate()) {
        ...
        registerButton = findViewById<View>(R.id.register_button).apply {
            setOnClickListener(View.OnClickListener { _: View? ->
                if (!validate()) {
                    return@OnClickListener
                }
    ...
    internal class LoginCallback(loginActivity: LoginActivity?) : UserServices.Callback() {
        private val mLoginActivity: WeakReference<LoginActivity?> = WeakReference<LoginActivity?>(loginActivity)
