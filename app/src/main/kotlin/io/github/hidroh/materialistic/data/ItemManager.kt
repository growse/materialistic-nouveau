...
interface ItemManager {
    ...
    @StringDef(TOP_FETCH_MODE, NEW_FETCH_MODE, ASK_FETCH_MODE, SHOW_FETCH_MODE, JOBS_FETCH_MODE, BEST_FETCH_MODE)
     ...
     */
    fun getStories(filter: String, @CacheMode cacheMode: Int, listener: ResponseListener<Array<Item>>?)
     ...
     */
    @WorkerThread
    fun getStories(filter: String, @CacheMode cacheMode: Int): Array<Item>?
     ...
     */
    @WorkerThread
    fun getItem(itemId: String, @CacheMode cacheMode: Int): Item?
}
