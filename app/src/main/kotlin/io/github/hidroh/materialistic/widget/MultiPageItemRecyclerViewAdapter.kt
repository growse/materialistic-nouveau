...
public class MultiPageItemRecyclerViewAdapter
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_FOOTER) {
            return ItemViewHolder(mLayoutInflater.inflate(R.layout.item_footer, parent, false), null)
        }
        return ItemViewHolder(mLayoutInflater.inflate(R.layout.item_comment, parent, false))
    }
