...
open class ThreadPreviewRecyclerViewAdapter : ItemRecyclerViewAdapter<SubmissionViewHolder>() {
    private val mItems: List<Item> = new ArrayList<>()
    private val mExpanded: List<String> = new ArrayList<>()
