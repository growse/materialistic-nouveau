...
public abstract class ListRecyclerViewAdapter
    ...
    open class ItemViewHolder : RecyclerView.ViewHolder() {
        private var mStoryView: StoryView? = null
        private var mCardView: FlatCardView? = null
        private val mCardElevation: Int = 0

        interface ShowMoreOptionsListener {
        ...
        fun bind(item: WebItem, hotThreshold: Int, selected: Boolean, cardViewEnabled: Boolean, itemClickListener: View.OnClickListener, commentClickListener: View.OnClickListener) {
        ...
        fun bindMoreOptions(listener: ShowMoreOptionsListener, allowLongClick: Boolean) {
            if (allowLongClick) {
